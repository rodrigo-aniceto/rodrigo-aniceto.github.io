    ...
    <footer className="bg-secondary text-white/80 py-12 mt-auto border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-24">
          ...
          <div className="space-y-6">
            <Link
              ...
              aria-label="Amigos na Dor - Página Inicial"
            >
            ...
            <p className="text-sm leading-relaxed text-white/70 max-w-sm">
              Um espaço de apoio religioso e acolhimento anônimo para quem
              precisa de conforto em momentos de aflição. Você não está sozinho.
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-4">
              <a
                ...
                className="p-2 bg-white/5 rounded-full hover:bg-accent hover:text-primary transition-all focus:outline-none focus:ring-2 focus:ring-accent"
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-white/70">
          ...
          <p>
            &copy; Igreja Presbiteriana Nacional – 2016-{currentYear}. Todos os
            direitos reservados.
          </p>
        </div>
      </div>
